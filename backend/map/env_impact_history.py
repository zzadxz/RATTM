...
def get_ESG_score_of_transaction_companies(
...
def get_total_green_transactions(
    transactions: dict[int, dict], ESG_scores: dict[str, dict]
) -> int:
    """
...
def get_most_purchased_companies(
    transactions: dict[int, dict], ESG_scores: dict[str, dict]
) -> list[dict[str, float]]:
    """
...
def calculate_historical_scores(
    frequency: str, transactions: dict[int, dict], esg_scores: dict[str, dict]
) -> list[int]:
    """
