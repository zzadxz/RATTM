...
def get_weekly_green_transactions(request): # IMPLEMENTED
...
def get_weekly_carbon_score(request): # IMPLEMENTED
    user_id = request.session["user_id"]
...
def get_monthly_carbon_score(request): # IMPLEMENTED
    user_id = request.session["user_id"]
...
def get_total_green_transactions(request): # IMPLEMENTED
    user_id = request.session["user_id"]
